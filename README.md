...
> Color-Gen-React is a website created with React.js, styled with TailwindCSS, and formatted using Prettier to make the code cleaner. Color-Gen-React is a simple website where you can generate 20 variations of the color you have selected.
